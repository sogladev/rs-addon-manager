...
const images = [
  {
    src: new URL(`/src/assets/images/image-1280x720-0.jpg`, import.meta.url).href,
    title: 'The Pantheon',
    caption:
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-1.jpg`, import.meta.url).href,
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-2.jpg`, import.meta.url).href,
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-3.jpg`, import.meta.url).href,
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-4.jpg`, import.meta.url).href,
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-5.jpg`, import.meta.url).href,
  ...
  {
    src: new URL(`/src/assets/images/image-1280x720-6.jpg`, import.meta.url).href,
...
function start() {
  if (autoplayTimer === undefined) {
    autoplayTimer = window.setInterval(nextSlide, CAROUSEL_INTERVAL_IN_MILLISECONDS);
  }
}
...
<template>
  <div class="carousel w-full" @mouseover="pause" @mouseleave="start">
    ...
    <div v-for="(image, i) in images" :key="i" :id="`slide${i + 1}`" class="carousel-item relative w-full flex">
      ...
      <div class="carousel-control absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
